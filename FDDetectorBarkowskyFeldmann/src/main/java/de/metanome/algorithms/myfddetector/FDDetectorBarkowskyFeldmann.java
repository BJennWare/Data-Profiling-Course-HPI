...
public class FDDetectorBarkowskyFeldmann extends FDDetectorAlgorithmBarkowskyFeldmann                // Separating the algorithm implementation and the Metanome interface implementation is good practice
    ...
    public ArrayList<ConfigurationRequirement<?>> getConfigurationRequirements() { // Tells Metanome which and how many parameters the algorithm needs
        ...
        conf.add(new ConfigurationRequirementRelationalInput(FDDetectorBarkowskyFeldmann.Identifier.INPUT_GENERATOR.name()));
        return conf;
    }
...
//		mode = MODE.Performance;
    ...
    public void setRelationalInputConfigurationValue(String identifier, RelationalInputGenerator... values) throws AlgorithmConfigurationException {
        if (!FDDetectorBarkowskyFeldmann.Identifier.INPUT_GENERATOR.name().equals(identifier))
